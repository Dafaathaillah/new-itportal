...
Route::middleware(['auth:sanctum', 'type.technician'])->group(function () {
    Route::post('/logout', [AuthController::class, 'logout']);
...
Route::middleware(['auth:sanctum', 'type.group_leader'])->group(function () {
    Route::post('/logout', [AuthController::class, 'logout']);
...
Route::middleware(['auth:sanctum', 'type.section_head'])->group(function () {
    Route::post('/logout', [AuthController::class, 'logout']);
