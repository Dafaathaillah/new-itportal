...
return new class extends Migration
{
    ...
    {
        Schema::create('inspeksi_access_points', function (Blueprint $table) {
            $table->id();

            $table->unsignedBigInteger('inv_ap_id')->nullable();
            $table->foreign('inv_ap_id')->references('id')->on('inv_aps')->cascadeOnDelete()->nullable();
    ...
    {
        Schema::dropIfExists('inspeksi_access_points');
    }
};
