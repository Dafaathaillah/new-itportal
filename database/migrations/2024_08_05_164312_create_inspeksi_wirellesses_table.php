...
return new class extends Migration
{
    ...
    {
        Schema::create('inspeksi_wirellesses', function (Blueprint $table) {
            $table->id();

            $table->unsignedBigInteger('inv_wirelless_id')->nullable();
            $table->foreign('inv_wirelless_id')->references('id')->on('inv_wirellesses')->cascadeOnDelete()->nullable();
    ...
    {
        Schema::dropIfExists('inspeksi_wirellesses');
    }
};
